...
(function(){
    ...
    */
    let suma = function (number1,number2){
        return number1+number2;
    }
    console.log( 'O resultado da soma é:',sum(suma) );
    // ?
    ...
    */
    let subtraction = calculator(20,30);
    let multiplication = calculator(40,50);
    let division = calculator(60,80);
    let mod = calculator(10,20);
    // ?
    ...
    chamada.
    */
    let subs = function (number1,number2){
        return number1-number2;
    }
    let multi = function (number1,number2){
        return number1*number2;
    }
    let divi = function (number1,number2){
        return number1/number2;
    }
    console.log( 'O resultado da subtração é:',subtraction(subs) );
    // ?

    console.log( 'O resultado da multiplicação é:',multiplication(multi) );
    // ?

    console.log( 'O resultado da divisão é:',division(divi) );
    // ?
