(function (){
    ...
    */
    // ?
    let newSudeste = brasil.splice(4,8);
    ...
    */
    let result_filter = brasil.every(function(item){
        return item.length > 7
    });
    console.log( '\nTodos os estados de `brasil` tem mais de 7 letras?' );
    // ?
    result_filter ? console.log("Sim, todos os estados tem mais de 7 letras!") : console.log("Nem todos os estados tem mais de 7 letras!") ;
    /*
    ...
    */
    let filter_ceara = brasil.some(function(item){
        return item = "Ceará"
    });
    console.log( '\nCeará está incluído em `brasil`?' );
    // ?
    filter_ceara ? console.log("Ceará está incluído!") : console.log("Ceará não foi incluído :(");
    /*
