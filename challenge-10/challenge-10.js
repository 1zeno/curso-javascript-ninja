...
*/
    ...
    */
    operationSignalSub = "-";
    let subtraction = calculator(operationSignalSub);
    operationSignalMult = "*";
    let multiplication = calculator(operationSignalMult);
    operationSignalDivi = "/";
    let division = calculator(operationSignalDivi);
    operationSignalMod = "%";
    ...
    if (subtraction){
        ...
        showErrorMessage(operationSignalSub);
    }

    console.log(showOperationMessage(number1,number2,operationSignalSub), subtraction(number1,number2));
    ...
    if (multiplication){
        ...
        showErrorMessage(operationSignalMult);
    }

    console.log(showOperationMessage(number1,number2,operationSignalMult), multiplication(number1,number2));
    ...
    if (division){
        ...
        showErrorMessage(operationSignalDivi);
    }

    console.log(showOperationMessage(number1,number2,operationSignalDivi), division(number1,number2));
    ...
    if (mod){
        ...
        showErrorMessage(operationSignalMod);
    }

    console.log(showOperationMessage(number1,number2,operationSignalMod), mod(number1,number2));
    // ?
    ...
    */
    operationSignalTeste = "algo";
    let teste = calculator(operationSignalTeste);
    if (!teste){

        showErrorMessage(operationSignalTeste);
    }
